...
abstract contract InterestEarningStrategy is IStrategyV2, Controllable {
  ...
  */
  ...
  function addInterest() external onlyGovernance {
    ...
    ERC20PresetMinterPauser(address(underlyingToken)).mint(address(this), underlyingToken.balanceOf(address(this)).div(20));
  }
